...
vim.opt.autochdir = true           -- always set the cwd to the opened file's location
vim.opt.scrolloff = 8
vim.opt.sidescrolloff = 8
vim.opt.expandtab = true
vim.opt.listchars:append("tab:»\\") -- Use » to mark tabs
vim.opt.listchars:append("trail:°") -- Use ° to mark trailing whitespace
